namespace NArrange.Tests.CSharp
{
    ...
    public class CSharpParserTests
    {
        ...
        public void ExpectedBlockCloseTest()
        {
            ...
            Assert.That(ex.Message, Is.EqualTo("Expected }: Line 2, Column 2"));
        }
        ...
        public void ExpectedFieldEndOfStatementTest()
        {
            ...
            Assert.That(ex.Message, Is.EqualTo("Unexpected end of file. Expected ;: Line 7, Column 2"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Is.EqualTo("Expected an initial value: Line 5, Column 31"));
        }
        ...
        public void ParseClassEmptyParameterConstraintListTest()
        {
         ...
         delegate
         {
            ...
            Assert.That(ex.Message, Does.Contain("Expected a class or interface name"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected type parameter constraint"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Invalid new constraint, use new()"));
        }
 ...
 delegate
 {
     ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Missing end region directive for 'Fields'"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("must be the last declared type parameter constraint"));
        }
 ...
 delegate
 {
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Unhandled element"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Unknown type parameter"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Cannot arrange files with preprocessor directives containing attributes unassociated to an element"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected a condition expression"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected #endif"));
        }
        ...
        public void ParseConditionDirectiveUnhandledTest()
        {
         ...
         delegate
         {
            ...
            Assert.That(ex.Message, Does.Contain("Unhandled preprocessor"));
        }
 ...
 delegate
 {
     ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Unmatched end region directive"));
        }
     ...
     delegate
     {
         ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Cannot arrange files with preprocessor directives"));
        }
     ...
     delegate
     {
         parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Unhandled element text"));
        }
 ...
 delegate
 {
     ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected a namepace name"));
        }
   ...
   delegate
   {
       ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected a type or namepace name"));
        }
        ...
        public void ParseUsingExpectedStatementEnd()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Expected = or ;"));
        }

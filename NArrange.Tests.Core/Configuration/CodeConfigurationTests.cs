namespace NArrange.Tests.Core.Configuration
{
	...
	public class CodeConfigurationTests
	{
		...
		public void CloneTest()
		{
			...
			Assert.AreEqual(defaultConfig.Formatting.Regions.EndRegionNameEnabled,
				clonedConfig.Formatting.Regions.EndRegionNameEnabled, "Regions configuration was not copied correctly.");
		}

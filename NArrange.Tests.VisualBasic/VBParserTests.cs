namespace NArrange.Tests.VisualBasic
{
    ...
    public class VBParserTests
    {
        ...
        public void ExpectedBlockCloseTest()
        {
            ...
            Assert.That(ex.Message, Is.EqualTo("Expected End Namespace: Line 1, Column 26"));
        }
 ...
 delegate
 {
     ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected an initial value"));
        }
 ...
 delegate
 {
     parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected End"));
        }
 ...
 delegate
 {
     ReadOnlyCollection<ICodeElement> elements = parser.Parse(reader);
            ...
            Assert.That(ex.Message, Does.Contain("Expected region name"));
        }
        ...
        public void ParseConditionDirectiveMissingEndTest()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Expected #End If"));
        }
        ...
        public void ParseInvalidTypeDefinitionTest()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Expected End Class"));
        }
        ...
        public void ParseMethodBodyUnexpectedEndOfFileTest()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Unexpected end of file. Expected End Sub"));
        }
        ...
        public void ParseNamespaceExpectedNamespace()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Expected End Namespace"));
        }
        ...
        public void ParseUsingInvalidTest()
        {
            ...
            Assert.That(ex.Message, Does.Contain("Expected = or end of statement"));
        }
